 ...
 "cells": [
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "50bec9910540e00be6b8c30cde11fe8adfe12318"
   },
   "source": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "49347492fe47aa4c25705e64a6d9899c185935f8"
   },
   "source": [
    "**Introduction**\n",
    "\n",
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "5cdfb7348c70903bf3eb281c7573100cce8b3d72"
   },
   "source": [
    "### What are the labels?"
   ]
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "8ef8ffdc93d54089bd6cb35fc2fecfdf187a119c"
   },
   "source": [
    "\n",
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "286a5b9125c6cca0ea989e00c0355326794a8ec1",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "492ed5b3c8ab34a1f1511ad489c978b29267ddb6",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "e5c24782c7ba338a58e0f1f43f9c5bdd1babc3f3",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "27cfbb4b833ad118b19806bd644f96aa02533651"
   },
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "ebd4f30e06ceb2ae6bf992325501998420ac61e5",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "22f5fc095e1cba8d4c3535b4387bbf59b4a082ab",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "2a0f3d5edbe37b2dc9fd46189e3fdcb63da4feb1",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "6d6b11f3b0f26f1e22993896a20cfd1d90d5c5d1",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "21d2d3c8c75e6ac7a9ba9480b222c9b9ec3e60fa",
    "trusted": true
   },
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    "_kg_hide-input": true,
    "_uuid": "4777cecabf520c32ace90e8e96cad895663a89e8",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "1651542ea66843ca948042a4047c89bb405d9009",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "ad6701c7a0c292293c71b7487c4597220816e35a",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "fffaaebc9c51867063fe3859e48c9b913adce501"
   },
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "a9dad0671ac757d75d0524080ba7b1013a535b37",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "fdffc711f9b7a4346569d1c79a45704c2d660ee6",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "e661e622490e1a574bb9da2a24b9d08ad3e05f8f"
   },
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "4414c95eb7f2729d54f4a0e422061a45f209dfec",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "0c5b5485b90e1520629f88093ebe2e0fbb5c3a98",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "5cd4d67bbe66b84374d3b64c5651f901602f4603",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "470db2e9a0f8ea62bb434de381dc6e9d065a3a30",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "ca2b267a97f465a4fc7803b072689eb661890168",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "76f9499d5fe8e7cb4954c11fe9a592e4d6e4776d",
    "trusted": true
   },
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "395839a0b38b954aee0b8fca348a07909f502432",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "143ee5937df6cbd0cd673cd70e0b17be85453bdb",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "1a1e42fd565256d1f7f1b2a7c9ab1756680ed25a",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "91a023f302fc8c994235d6f4035cb22ae541a3c3"
   },
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    "_kg_hide-input": true,
    "_uuid": "e1ffd40b1eae248776a0c70d863a93dfd5fd99a6",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "b60712c6405c98634a97b1b96bc6516329e279ae",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "_uuid": "b0d1a01f403a481e3f7ca715d46aa84a8aff7a4a",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "2721a2820d76bdb39facec5d2fb3eebe868da45f",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    "_kg_hide-output": true,
    "_uuid": "4605aad533f3afe0a6eb7dc869d0448d45bb26f6",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "af6b19047f132f55ae24e207546d7cb8dc3db103",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "db8cbeee5345aa7febf247707728a764e8e7c4b5",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "8c3ff294228f20573abed1b00452c781f9afdbfe"
   },
   "source": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "b1a76feeb9618c21b90a0fc02e23e1a7ce8d6e82"
   },
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "ca0b1bc3df3a41c29a1326c85f15ca77362d2c81",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "16d10a81e76ae51b3a72c492b498b543ccf12cce",
    "trusted": true
   },
   "outputs": [],
   "source": []
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "bc6f0bdce1a5a18d6c045eda2b58abb92e089d47",
    "trusted": true
   },
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "2ee8c8e590bfaa8800d436ff875df34968d279d3",
    "trusted": true
   },
   "source": [
    "**Reference Kernels:**\n",
  ...
  },
  {
   "cell_type": "markdown",
   "metadata": {
    "_uuid": "3686f78c6646cc64bd0c199f2e0d0f9dafebac49",
    "trusted": true
   },
   "source": [
    "**Conclusion**\n",
  ...
  },
  {
   ...
   "execution_count": null,
   "metadata": {
    "_uuid": "c4bd4206e580522661299e470d163eb97d4e8f0c",
    "trusted": true
   },
   "outputs": [],
   "source": []
